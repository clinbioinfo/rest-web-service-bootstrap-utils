package REST::WebService::Bootstrapper::Logger;
...
B<Description:> Instantiate REST::WebService::Bootstrapper::Logger object

B<Parameters:> 

 %args

B<Returns:> Returns a reference to REST::WebService::Bootstrapper::Logger
...
sub _initConfiguration {
    ...
    my $conf = q(
    log4perl.logger                    = sub {return REST::WebService::Bootstrapper::Logger::_getLogLevel();}

    log4perl.appender.Logfile          = Log::Log4perl::Appender::File
    log4perl.appender.Logfile.filename = sub { return REST::WebService::Bootstrapper::Logger::_getLogfile(); }
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new REST::WebService::Bootstrapper::Logger(@_);

        if (!defined($instance)){
            confess "Could not instantiate REST::WebService::Bootstrapper::Logger";
        }
    }
...
B<Description:> REST::WebService::Bootstrapper::Logger class destructor
...
=head1 NAME
 ...
 REST::WebService::Bootstrapper::Logger
...
=head1 SYNOPSIS
 ...
 my $obj = REST::WebService::Bootstrapper::Logger::getInstance();
